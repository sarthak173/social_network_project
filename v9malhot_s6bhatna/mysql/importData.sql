LOAD DATA LOCAL INFILE "reduced_comments.csv"
INTO TABLE postcomment
COLUMNS TERMINATED BY ','
LINES TERMINATED BY '\n'
IGNORE 1 LINES;

LOAD DATA LOCAL INFILE "reduced_post.csv"
IGNORE INTO TABLE post
COLUMNS TERMINATED BY ','
LINES TERMINATED BY '\n'
IGNORE 1 LINES;

LOAD DATA LOCAL INFILE "reduced_like.csv"
INTO TABLE postlike
COLUMNS TERMINATED BY ','
LINES TERMINATED BY '\n'
IGNORE 1 LINES;

LOAD DATA LOCAL INFILE "reduced_member.csv"
IGNORE INTO TABLE person
COLUMNS TERMINATED BY ','
LINES TERMINATED BY '\n'
IGNORE 1 LINES;

LOAD DATA LOCAL INFILE "reduced_login.csv"
IGNORE INTO TABLE login
COLUMNS TERMINATED BY ','
LINES TERMINATED BY '\n'
IGNORE 1 LINES;

LOAD DATA LOCAL INFILE "reduced_friend.csv"
